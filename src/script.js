...
function showContacts(contactBook, groupToShow) { // Rör ej denna kod
   ...
   for (contact of contactBook) {
     if (contact.group = groupToShow) {
    return `Name: ${contact.name} - Phonenumber: ${contact.phone}` // här ska sträng med namn och tekefonnummer visas i form av string interpolation
     }
   }
}
